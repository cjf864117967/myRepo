  ...
  <body>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-body">
						...
						<input type="button" value="添加图片" id="add"><br>
				    	<p id="p" >
				    	
				    		<br>
				    		<input name="pictures" type="file"   class="form-control" placeholder="添加图片"/>
	...
	<script src="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote.js"></script>
	 <script type="text/javascript">
    	$("#add").click(function(){
    		$("#p").append("<br><input name='title' type='file'   class='form-control' placeholder='添加图片'/>")
    	});
    </script>
	<script type="text/javascript">
