...
public class GenEntityOracle {
    ...
    private String packageOutPath = "main/java/com.bw.bean";// 指定实体生成所在包的路径
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/test?user=root&password=root&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
    	...
    	//第一个参数表名    第二个参数实体类名    第三个参数数据库名字
        new GenEntityOracle("area","Area","test").init();  
        new GenEntityOracle("classify","Classify","test").init();
        new GenEntityOracle("movie","Movie","test").init();
    }  
}
